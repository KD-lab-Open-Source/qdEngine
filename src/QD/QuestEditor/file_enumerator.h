...
author:		Илюха
  ...
  purpose:	Enumerator, который позволяет продвигаться
...
/// Данные возвращаемые итератором
...
/// Класс, который перечисляет все файлы в текущем каталоге.
/**
	 Для создания экземпляра
	нужно указать лишь маску.

	file_enumerator fe("..\*.tga");
	file_enumerator::iterator i = fe.begin(), e = fe.end();
	.....
 */
